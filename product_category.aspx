<%@ Page Title="Product Category" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="product_category.aspx.vb" Inherits="_Default" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        ...
                        <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="Id" DataSourceID="SqlDataProductCategory">
                            <EditItemTemplate>
                                Id:
                        ...
                        <asp:SqlDataSource ID="SqlDataProductCategory" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionWebsite %>" DeleteCommand="DELETE FROM [Product_category] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Product_category] ([Id], [Name], [Parent_category_id]) VALUES (@Id, @Name, @Parent_category_id)" SelectCommand="SELECT [Id], [Name], [Parent_category_id] FROM [Product_category]" UpdateCommand="UPDATE [Product_category] SET [Name] = @Name, [Parent_category_id] = @Parent_category_id WHERE [Id] = @Id">
                            <DeleteParameters>
