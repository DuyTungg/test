<%@ Page Title="Client" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="client.aspx.vb" Inherits="_Default" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        ...
                        <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="Id" DataSourceID="SqlDataClient">
                            <EditItemTemplate>
                                Id:
                        ...
                        <asp:SqlDataSource ID="SqlDataClient" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionWebsite %>" DeleteCommand="DELETE FROM [Client] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Client] ([Id], [Full_name], [Email]) VALUES (@Id, @Full_name, @Email)" SelectCommand="SELECT [Id], [Full_name], [Email] FROM [Client]" UpdateCommand="UPDATE [Client] SET [Full_name] = @Full_name, [Email] = @Email WHERE [Id] = @Id">
                            <DeleteParameters>
