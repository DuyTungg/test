<%@ Page Title="Purchase Item" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="purchase_item.aspx.vb" Inherits="_Default" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <h2 class="section-title">Purchase Item</h2>

                        <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="Id" DataSourceID="SqlDataPurchaseItem">
                            <EditItemTemplate>
                                Id:
                        ...
                        <asp:SqlDataSource ID="SqlDataPurchaseItem" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionWebsite %>" DeleteCommand="DELETE FROM [Purchase_item] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Purchase_item] ([Id], [Purchase_id], [Product_id], [Amount]) VALUES (@Id, @Purchase_id, @Product_id, @Amount)" SelectCommand="SELECT [Id], [Purchase_id], [Product_id], [Amount] FROM [Purchase_item]" UpdateCommand="UPDATE [Purchase_item] SET [Purchase_id] = @Purchase_id, [Product_id] = @Product_id, [Amount] = @Amount WHERE [Id] = @Id">
                            <DeleteParameters>
